...
class account{
	...
	public function create ($login, $pwd, $repwd, $email, $img = null,$LCoins = 0,$Fuser = '') {
		...
		$sql = sprintf("INSERT INTO `accounts` (`login`,`password`,`lastactive`,`".CONFIG::g()->accessLevel()."`,`lastIP`,`email`,`coins`,`userForum`) VALUES ('%s', '%s', '%s', '-1', '%s', '%s','%s','%s');",
